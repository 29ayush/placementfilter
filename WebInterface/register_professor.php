...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
  ...
  elseif(!$dept)
    $error = "Department can't be empty";
  elseif(!$staffid)
    $error = "Staff Id can't be empty";
  else
  {
 include_once 'db.php';
  $conn = get_rconn();
  $sql  = "call createuserprof('{$Password}','{$username}','{$name}',".$staffid.",'{$email}',{$pno},'{$dept}')";
...
<form action="#" id="signform" method="POST">
 ...
 <div class="form-group"> 
  ...
  <div class="form-group"> 
    ...
    <input type="text" class="form-control" name="staffid" value="<?php echo $staffid; ?>" placeholder="XY090XSU" maxlength="10">
  </div>
  <div class="form-group"> 
